...
export default function DetailLearnSection(props) {
        ...
        <>
            <ScrollView style={{ flex: 1 }}>
                ...
                <View style={{ width: '100%', height: '100%' }}>
                    ...
                    <Text style={{ textAlign: 'center', fontSize: 14, paddingBottom: 30 }}>Now select which subcategory you would like to learn</Text>
                        ...
                        {subAreas.areas.map((el, i) => {
                            return (
                                <View key={i} style={{
                                    ...
                                    <TouchableOpacity onPress={() => { dispatch({ type: 'SUB_AREA_NAME', payload: el.name }), navigation.navigate('ChooseLearn', el.name) }}>
